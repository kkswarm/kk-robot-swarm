...
// Generated 16-May-2022 17:05:19
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"c1_soft_border0516\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(c1_soft_border0516_M, (NULL));
        c1_soft_border0516_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(c1_soft_border0516_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(c1_soft_border0516_M)
                == (NULL)) || rtmGetStopRequested(c1_soft_border0516_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(c1_soft_border0516_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
