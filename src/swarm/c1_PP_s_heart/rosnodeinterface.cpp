  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"c1_PP_s_heart\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(c1_PP_s_heart_M, (NULL));
        c1_PP_s_heart_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(c1_PP_s_heart_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(c1_PP_s_heart_M)
                == (NULL)) || rtmGetStopRequested(c1_PP_s_heart_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(c1_PP_s_heart_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
